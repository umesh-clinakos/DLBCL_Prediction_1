...
OhdsiRTools::checkUsagePackage("DLBCLPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/DLBCLPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/DLBCLPrediction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("DLBCLPrediction")
