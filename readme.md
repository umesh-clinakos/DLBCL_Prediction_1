...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/DLBCLPrediction/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  library(DLBCLPrediction)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./DLBCLPredictionResults"
...
cohortTable <- 'DLBCLPredictionCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/DLBCLPrediction")
```
